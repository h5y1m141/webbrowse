...
// in simulator we redefine to format for webbrowse Developer console
...
{\
	NSString * exceptionName = [@"org.webbrowse." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.webbrowse";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIwebbrowseNativeItemNone = -1, 
	UIwebbrowseNativeItemSpinner = -2,
	UIwebbrowseNativeItemProgressBar = -3,
	
	UIwebbrowseNativeItemSlider = -4,
	UIwebbrowseNativeItemSwitch = -5,
	UIwebbrowseNativeItemMultiButton = -6,
	UIwebbrowseNativeItemSegmented = -7,
	
	UIwebbrowseNativeItemTextView = -8,
	UIwebbrowseNativeItemTextField = -9,
	UIwebbrowseNativeItemSearchBar = -10,
	
	UIwebbrowseNativeItemPicker = -11,
	UIwebbrowseNativeItemDatePicker = -12,
	
	UIwebbrowseNativeItemInfoLight = -13,
	UIwebbrowseNativeItemInfoDark = -14,
	
	UIwebbrowseNativeItemDisclosure = -15,
	
	UIwebbrowseNativeItemContactAdd = -16
};
