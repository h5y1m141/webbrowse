...
//@interface webbrowseObject : NSObject
//@end

@interface webbrowseObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[webbrowseObject class]])
		{
			for (NSString *key in [[(webbrowseObject*)o modules] allKeys])
			{
